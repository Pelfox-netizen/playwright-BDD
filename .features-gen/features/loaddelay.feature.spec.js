...
test.describe('Load Delays', () => {
  ...
  test('Verify the Load Delay page title', async ({ Given, Then, page }) => { 
    await Given('I navigate to the Load Delay page', null, { page }); 
    await Then('the page title should contain "Load Delay"', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":14,"pickleLine":13,"tags":[],"steps":[{"pwStepLine":15,"gherkinStepLine":14,"keywordType":"Context","textWithKeyword":"Given I navigate to the Load Delay page","stepMatchArguments":[]},{"pwStepLine":16,"gherkinStepLine":15,"keywordType":"Outcome","textWithKeyword":"Then the page title should contain \"Load Delay\"","stepMatchArguments":[{"group":{"start":30,"value":"\"Load Delay\"","children":[{"start":31,"value":"Load Delay","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end